...
--[[Map is "Mustafar"]]
	...
	EnemyStats = {
		...
		quick    = { unit = "Droideka", 	  health = 743,  speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 3375,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 6075, speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 2497.5,  speed = 3,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 9450, speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 39750, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 140, Items = { ["Red Milk"] = 4,},	PlayerExp = 50
	},
	Rounds = {
		{
