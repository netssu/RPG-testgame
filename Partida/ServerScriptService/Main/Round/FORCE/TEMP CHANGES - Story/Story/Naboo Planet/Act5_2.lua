...
--[[Map is "Naboo Planet"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 90,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 55,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 250,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 450,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 185,  speed = 3,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 700,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 2000, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 65, Items = { ["Milk"] = 3,},	PlayerExp = 25
	},
	Rounds = {
		{
