...
--[[Map is "Destroyed Kamino"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "Ace",	    health = 1823,  speed = 4,    money_reward = 30},
		quick    = { unit = "Bobby", 	health = 1114,  speed = 6,    money_reward = 75},
		tank     = { unit = "Croozie",  health = 5063,  speed = 2.5,  money_reward = 50}, 
		strong   = { unit = "Jack the worst community manager in the world", health = 9113, speed = 1.5, money_reward = 75}, 
		debuff   = { unit = "Fauzen",   health = 3746,  speed = 2,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "Mathirix", health = 14175, speed = 3, money_reward = 150},
		boss     = { unit = "Scruffy",  health = 60625, speed = 2, money_reward = 1500},

	},
	Rewards = {	Gems = 195, Items = { ["Red Milk"] = 4,},	PlayerExp = 60
	},
	Rounds = {
		{
...
--[[4]]		wave = { { unit = "normal",   amount = 7  }, 
					 { unit = "quick",    amount = 4  }, 
					 { unit = "tank",     amount = 4  } }, wave_reward = 325, wave_diff_scale = 0.35},
		{
...
--[[15]]	wave = { { unit = "normal",   amount = 10 }, 
					 ...
					 { unit = "quick",    amount = 5  },
				     { unit = "debuff",   amount = 1  }, 
	                 { unit = "miniboss", amount = 4  } }, wave_reward = 0, wave_diff_scale = 1, boss_wave = true
		} 
