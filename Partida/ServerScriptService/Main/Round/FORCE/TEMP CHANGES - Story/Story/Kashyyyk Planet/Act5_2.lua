...
--[[Map is "Kashyyyk"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 360,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 220,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 1000,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 1700,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 740,   speed = 3,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 2800,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 13000, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 80, Items = { ["Blue Milk"] = 3,},	PlayerExp = 35
	},
	Rounds = {
		{
