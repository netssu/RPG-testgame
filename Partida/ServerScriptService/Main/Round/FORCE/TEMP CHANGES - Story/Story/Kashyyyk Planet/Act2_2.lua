...
--[[Map is "Kashyyyk"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 240,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 160,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 700,   speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 1200,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 560,   speed = 3,    money_reward = 125, amount = 0.25}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 1900,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 10750, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 65, Items = { ["Blue Milk"] = 2,},	PlayerExp = 27
	},
	Rounds = {
		{
