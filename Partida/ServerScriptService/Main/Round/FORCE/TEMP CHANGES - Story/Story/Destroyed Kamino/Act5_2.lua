...
--[[Map is "Destroyed Kamino"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 1823,  speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 1114,  speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 5063,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 9113, speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 3746,  speed = 3,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 14175, speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 58625, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 165, Items = { ["Red Milk"] = 4,},	PlayerExp = 55
	},
	Rounds = {
		{
