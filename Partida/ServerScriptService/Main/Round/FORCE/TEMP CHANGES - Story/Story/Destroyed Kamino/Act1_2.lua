...
--[[Map is "Destroyed Kamino"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 1013,  speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 709,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 3038,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 5063,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 2531,  speed = 3,    money_reward = 125, amount = 0.25}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 8100, speed = 1.5, money_reward = 150},
		boss     = { unit = "Tact",           health = 50625, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 145, Items = { ["Red Milk"] = 2,},	PlayerExp = 45
	},
	Rounds = {
		{
