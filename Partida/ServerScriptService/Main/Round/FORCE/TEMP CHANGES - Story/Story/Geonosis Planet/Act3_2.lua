...
--[[Map is "Geonosis"]]
	...
	EnemyStats = {
		...
		tank     = { unit = "B2",             health = 400,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 700,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 310,  speed = 3,    money_reward = 125, amount = 0.3}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 1100, speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 6000, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 60, Items = { ["Yellow Milk"] = 2,},	PlayerExp = 24
	},
	Rounds = {
		{
