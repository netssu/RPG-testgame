...
--[[Map is "Geonosis"]]
	...
	EnemyStats = {
		...
		quick    = { unit = "Droideka", 	  health = 80,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 350,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 600,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 280,  speed = 3,    money_reward = 125, amount = 0.25}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 950,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 5500, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 55, Items = { ["Yellow Milk"] = 2,},	PlayerExp = 22
	},
	Rounds = {
		{
