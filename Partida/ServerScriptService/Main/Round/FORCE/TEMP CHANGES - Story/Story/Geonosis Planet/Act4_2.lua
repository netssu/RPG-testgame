...
--[[Map is "Geonosis"]]
	...
	EnemyStats = {
		...
		quick    = { unit = "Droideka", 	  health = 100,  speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 450,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 800,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 340,  speed = 3,    money_reward = 125, amount = 0.35}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 1250, speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 6500, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 65, Items = { ["Yellow Milk"] = 3,},	PlayerExp = 26
	},
	Rounds = {
		{
