...
--[[Map is "Tatooine"]]
	...
	EnemyStats = {
		...
		quick    = { unit = "Droideka", 	  health = 360,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 1575,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 2700,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 1260,  speed = 3,    money_reward = 125, amount = 0.25}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 4275,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 23750, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 100, Items = { ["Red Milk"] = 2,},	PlayerExp = 37
	},
	Rounds = {
		{
