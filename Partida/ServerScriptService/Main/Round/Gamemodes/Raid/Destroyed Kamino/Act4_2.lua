local module = {
	...
	Rewards = {
		...
		Tower = { unit = "Fifth Brother", chance = 3.5 } -- 0.5%
	},
	Rounds = {
		--[[1]]{ wave = { { unit = "normal", amount = 3 } }, wave_reward = 350, wave_diff_scale = 0.5 },
		--[[2]]{ wave = { { unit = "normal", amount = 5 } }, wave_reward = 450, wave_diff_scale = 0.5 },
