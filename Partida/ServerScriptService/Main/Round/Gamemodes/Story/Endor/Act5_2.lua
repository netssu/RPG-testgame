...
--[[Map is Hoth]]
	...
	wave_rest_time = 5,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 190,   speed = 2,   money_reward = 30},
		strong   = { unit = "SectarianGuard", health = 200,   speed = 2,   money_reward = 40}, 
		debuff   = { unit = "Battledroid",	  health = 190,   speed = 2,   money_reward = 40, amount = .75},
		tank     = { unit = "B2",             health = 195,   speed = 2,   money_reward = 50}, 
		quick    = { unit = "Droideka",    	  health = 170,   speed = 4,   money_reward = 75},
		miniboss = { unit = "BX",             health = 280,   speed = 1.7, money_reward = 150},
		boss     = { unit = "Tact",           health = 12500, speed = 2,   money_reward = 1500},
	},
	Rewards = {
		
		Gems = 300,
		Items = { ["Purple Milk"] = 4, }, PlayerExp = 85
	},
	Rounds = {
		{
