...
--[[Map is Hoth]]
	...
	Rewards = {
		...
		Gems = 250,
		Items = { ["Purple Milk"] = 4, }, PlayerExp = 72
	},
	Rounds = {
		{
...
--[[2]]		wave = { { unit = "normal",   amount = 7  }, 
					 { unit = "quick",    amount = 3  } },	wave_reward = 200, wave_diff_scale = 0.6}, 
		{
--[[3]]		wave = { { unit = "normal",   amount = 7  },
					 { unit = "tank",     amount = 3  } }, wave_reward = 250, wave_diff_scale = 0.75},
		{
--[[4]]		wave = { { unit = "normal",   amount = 7  }, 
					 { unit = "quick",    amount = 4  }, 
					 { unit = "tank",     amount = 4  } }, wave_reward = 325, wave_diff_scale = 1},
		{
--[[5]]		wave = { { unit = "normal",   amount = 7  },
					 ...
					 { unit = "strong",   amount = 3  } }, wave_reward = 525, wave_diff_scale = 1.25}, 
		{
--[[6]]		wave = { { unit = "normal",   amount = 8  }, 
					 { unit = "quick",    amount = 6  }, 
					 { unit = "tank",     amount = 3  } }, wave_reward = 525, wave_diff_scale = 1.5}, 
		{
--[[7]]		wave = { { unit = "normal",   amount = 8  }, 
					 { unit = "quick",    amount = 6  }, 
					 { unit = "tank",     amount = 3  } }, wave_reward = 550, wave_diff_scale = 1.75}, 
		{
--[[8]]		wave = { { unit = "normal",   amount = 8  }, 
					 { unit = "quick",    amount = 8  }, 
					 { unit = "tank",     amount = 5  } }, wave_reward = 550, wave_diff_scale = 2}, 
		{
...
--[[12]]	wave = { { unit = "normal",   amount = 12 }, 
					 { unit = "quick",    amount = 9  }, 
					 { unit = "tank",     amount = 7  }, 
					 { unit = "quick",    amount = 9  } }, wave_reward = 750, wave_diff_scale = 3.5}, 
		{
...
--[[15]]	wave = { { unit = "normal",   amount = 10 }, 
					 ...
					 { unit = "quick",    amount = 5  },
				     { unit = "debuff",   amount = 1  }, 
	                 { unit = "miniboss", amount = 4  } }, wave_reward = 0, wave_diff_scale = 5, boss_wave = true
		} 
