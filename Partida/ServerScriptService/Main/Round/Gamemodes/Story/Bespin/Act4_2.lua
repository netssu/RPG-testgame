...
--[[Map is Hoth]]
	...
	EnemyStats = {
		...
		boss     = { unit = "Tact",           health = 10500, speed = 2,   money_reward = 1500},
	},
	Rewards = {
		
		Gems = 240,
		Items = { ["Purple Milk"] = 3, }, PlayerExp = 69
	},
	Rounds = {
		{
...
--[[4]]		wave = { { unit = "normal",   amount = 7  }, 
					 { unit = "quick",    amount = 4  }, 
					 { unit = "tank",     amount = 3  } }, wave_reward = 325, wave_diff_scale = 0.85},
		{
--[[5]]		wave = { { unit = "normal",   amount = 7  },
					 ...
					 { unit = "strong",   amount = 3  } }, wave_reward = 525, wave_diff_scale = 1}, 
		{
--[[6]]		wave = { { unit = "normal",   amount = 8  }, 
					 { unit = "quick",    amount = 6  }, 
					 { unit = "tank",     amount = 3  } }, wave_reward = 525, wave_diff_scale = 1.25}, 
		{
--[[7]]		wave = { { unit = "normal",   amount = 8  }, 
					 { unit = "quick",    amount = 6  }, 
					 { unit = "tank",     amount = 3  } }, wave_reward = 550, wave_diff_scale = 1.5}, 
		{
--[[8]]		wave = { { unit = "normal",   amount = 8  }, 
					 { unit = "quick",    amount = 8  }, 
					 { unit = "tank",     amount = 5  } }, wave_reward = 550, wave_diff_scale = 1.75}, 
		{
...
--[[15]]	wave = { { unit = "normal",   amount = 10 }, 
					 ...
					 { unit = "quick",    amount = 5  },
	                 { unit = "miniboss", amount = 2  } }, wave_reward = 0, wave_diff_scale = 5, boss_wave = true
		} 
