...
local Beam = require(script.beam)
...
local CameraShake = require(script.camera_shake)
local TweenProperty = require(script.tween_property)
local ShockwaveRing = require(script.shockwave_ring)
local ShockwaveLine = require(script.shockwave_line)
local ShockwaveDebris = require(script.shockwave_debris)

local Promise = require(script.obj.Promise)
