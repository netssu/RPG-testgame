if true then return end -- disabled by ace, please make sure this breaks nothing
...
--
local XPHandler = require(ReplicatedStorage.EpisodeConfig.XPHandler)
...
for __ , Script : LocalScript in script:GetChildren() do
