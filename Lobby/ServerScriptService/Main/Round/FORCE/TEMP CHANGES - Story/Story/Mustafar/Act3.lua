...
--[[Map is "Mustafar"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 945,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 608,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 2700,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 4725,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 2093,  speed = 3,    money_reward = 125, amount = 0.3}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 7425,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 36750, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 130, Items = { ["Red Milk"] = 2,},	PlayerExp = 44
	},
	Rounds = {
		{
