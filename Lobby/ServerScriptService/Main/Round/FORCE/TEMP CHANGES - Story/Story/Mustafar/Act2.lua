...
--[[Map is "Mustafar"]]
	...
	EnemyStats = {
		...
		quick    = { unit = "Droideka", 	  health = 540,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 2363,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 4050,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 1890,  speed = 3,    money_reward = 125, amount = 0.25}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 6413,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 35250, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 125, Items = { ["Red Milk"] = 2,},	PlayerExp = 42
	},
	Rounds = {
		{
