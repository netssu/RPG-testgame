...
--[[Map is "Naboo Planet"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 70,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 45,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 200,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 350,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 155,  speed = 3,    money_reward = 125, amount = 0.3}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 550,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 1500, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 55, Items = { ["Milk"] = 2,},	PlayerExp = 19
	},
	Rounds = {
		{
