...
--[[Map is "Destroyed Kamino"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "Ace",	    health = 1215,  speed = 4,    money_reward = 30},
		quick    = { unit = "Bobby",    health = 810,   speed = 6,     money_reward = 75},
		tank     = { unit = "Croozie",  health = 3544,  speed = 2.5,  money_reward = 50}, 
		strong   = { unit = "Jack the worst community manager in the world", health = 6075, speed = 1.5, money_reward = 75}, 
		debuff   = { unit = "Fauzen",   health = 2835,  speed = 2,    money_reward = 125, amount = 0.25}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "Mathirix", health = 9169,  speed = 3,  money_reward = 150},
		boss     = { unit = "Scruffy",  health = 54625, speed = 2, money_reward = 1500},

	},
	Rewards = {	Gems = 180, Items = { ["Red Milk"] = 2,},	PlayerExp = 52
	},
	Rounds = {
		{
