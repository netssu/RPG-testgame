...
--[[Map is "Temple"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "Ace",	    health = 1418,  speed = 4,    money_reward = 30},
	 	quick    = { unit = "Bobby",    health = 911,   speed = 6,     money_reward = 75},
		tank     = { unit = "Croozie",  health = 4050,  speed = 2.5,  money_reward = 50}, 
		strong   = { unit = "Jack the worst community manager in the world", health = 7088, speed = 1.5, money_reward = 75}, 
		debuff   = { unit = "Fauzen",	health = 3139,  speed = 2,    money_reward = 125, amount = 0.3}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "Mathirix", health = 11138, speed = 3, money_reward = 150},
		boss     = { unit = "Scruffy",  health = 56625, speed = 2, money_reward = 1500},

	},
	Rewards = {	Gems = 185, Items = { ["Red Milk"] = 2,},	PlayerExp = 54
	},
	Rounds = {
		{
