...
--[[Map is "Kashyyyk"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 320,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 200,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 900,   speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 1600,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 680,   speed = 3,    money_reward = 125, amount = 0.35}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 2500,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 12250, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 75, Items = { ["Blue Milk"] = 3,},	PlayerExp = 31
	},
	Rounds = {
		{
