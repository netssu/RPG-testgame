...
--[[Map is "Tatooine"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 810,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 495,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 2250,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 4050,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 1665,  speed = 3,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 6300,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 27500, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 115, Items = { ["Red Milk"] = 3,},	PlayerExp = 45
	},
	Rounds = {
		{
