...
--[[Map is "Death Star"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 540,   speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 330,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 1500,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 2700,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 1110,  speed = 3,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 4200,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 19000, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 95, Items = { ["Red Milk"] = 3,},	PlayerExp = 40
	},
	Rounds = {
		{
