...
--[[Map is "Death Star"]]
	...
	EnemyStats = {
		...
		quick    = { unit = "Droideka", 	  health = 240,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 1050,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 1800,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 840,   speed = 3,    money_reward = 125, amount = 0.25}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 2850,  speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 16000, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 80, Items = { ["Red Milk"] = 2,},	PlayerExp = 32
	},
	Rounds = {
		{
