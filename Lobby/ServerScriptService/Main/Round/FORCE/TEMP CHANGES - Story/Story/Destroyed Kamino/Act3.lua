...
--[[Map is "Destroyed Kamino"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 1418,  speed = 2,    money_reward = 30},
		quick    = { unit = "Droideka", 	  health = 911,   speed = 4,    money_reward = 75},
		tank     = { unit = "B2",             health = 4050,  speed = 1.5,  money_reward = 50}, 
		strong   = { unit = "SectarianGuard", health = 7088,  speed = 1.35, money_reward = 75}, 
		debuff   = { unit = "Battledroid",	  health = 3139,  speed = 3,    money_reward = 125, amount = 0.3}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "BX",             health = 11138, speed = 1.75, money_reward = 150},
		boss     = { unit = "Tact",           health = 54625, speed = 1.25, money_reward = 1500},

	},
	Rewards = {	Gems = 155, Items = { ["Red Milk"] = 2,},	PlayerExp = 49
	},
	Rounds = {
		{
