local module = {
	...
	wave_rest_time = 5,
	EnemyStats = {
		normal = { unit = "B1", health = 325, speed = 2, money_reward = 30 },
		strong = { unit = "B2", health = 355, speed = 2, money_reward = 40 },
		tank = { unit = "BX", health = 385, speed = 2, money_reward = 50 },
		quick = { unit = "BATTLEDROID B-1 QUICK", health = 355, speed = 4, money_reward = 75 },
		miniboss = { unit = "Tie Interceptor", health = 610, speed = 1.7, money_reward = 150 },
		boss = { unit = "Wader Last Breath", health = 15160, speed = 1.6, money_reward = 1500 },
	},
	Rewards = {
		Gems = 60,
		Items = { ["Red Milk"] = 10 },
		...
		Tower = { unit = "Fifth Brother", chance = 5 } -- 0.5%
	},
	Rounds = {
