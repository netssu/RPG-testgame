local module = {
	...
	EnemyStats = {
		...
		strong = { unit = "B2", health = 310, speed = 2, money_reward = 40 },
		tank = { unit = "BX", health = 340, speed = 2, money_reward = 50 },
		quick = { unit = "BATTLEDROID B-1 QUICK", health = 310, speed = 4, money_reward = 75 },
		miniboss = { unit = "Tie Interceptor", health = 535, speed = 1.7, money_reward = 150 },
		boss = { unit = "Anikan Skaivoker", health = 8150, speed = 1.8, money_reward = 1500 },
	},
	...
	Rewards = {
		...
		Tower = { unit = "Fifth Brother", chance = 1 } -- 0.5%
	},
