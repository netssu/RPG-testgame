local module = {
	...
	EnemyStats = {
		normal = { unit = "Soldier", health = 190, speed = 2, money_reward = 30 },
		strong = { unit = "Stronger", health = 220, speed = 2, money_reward = 40 },
		tank = { unit = "Tank", health = 250, speed = 2, money_reward = 50 },
		quick = { unit = "BATTLEDROID B-1 QUICK", health = 220, speed = 4, money_reward = 75 },
		miniboss = { unit = "Tie Interceptor", health = 430, speed = 1.7, money_reward = 150 },
		boss = { unit = "Anikan Skaivoker", health = 3150, speed = 1.8, money_reward = 1500 },
	},
	...
	Rewards = {
		...
		Tower = { unit = "Asaka Tano", chance = 0.2 } -- 0.5%
	},

	Rounds = {
		--[[1]]{ wave = { { unit = "normal", amount = 3 } }, wave_reward = 300, wave_diff_scale = 0.5 },
