...
--[[Map is Hoth]]
	...
	Rewards = {
		...
		Gems = 275,
		Items = { ["Purple Milk"] = 2, }, PlayerExp = 72
	},
	Rounds = {
		{
...
--[[3]]		wave = { { unit = "normal",   amount = 4  },
					 { unit = "tank",     amount = 1  } }, wave_reward = 400, wave_diff_scale = 0.7},
		{
...
--[[5]]		wave = { { unit = "normal",   amount = 4  },
					 { unit = "quick",    amount = 4  }, 
					 { unit = "tank",     amount = 2  }, 
					 { unit = "strong",   amount = 1  } }, wave_reward = 650, wave_diff_scale = 0.85}, 
		{
...
--[[7]]		wave = { { unit = "normal",   amount = 5  }, 
					 { unit = "quick",    amount = 4  }, 
					 { unit = "tank",     amount = 3  } }, wave_reward = 700, wave_diff_scale = 1.25}, 
		{
...
--[[9]]		wave = { { unit = "normal",   amount = 6  }, 
					 { unit = "quick",    amount = 5  }, 
					 { unit = "tank",     amount = 3  }, 
					 { unit = "quick",    amount = 3  } }, wave_reward = 750, wave_diff_scale = 2}, 
		{
