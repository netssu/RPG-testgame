...
--[[Map is Hoth]]
	...
	wave_rest_time = 5,
	EnemyStats = {
		normal   = { unit = "B1",	          health = 110,  speed = 2,   money_reward = 30},
		strong   = { unit = "SectarianGuard", health = 130,  speed = 2,   money_reward = 40}, 
		debuff   = { unit = "Battledroid",	  health = 120,  speed = 2,   money_reward = 40, amount = .75},
		tank     = { unit = "B2",             health = 125,  speed = 2,   money_reward = 50}, 
		quick    = { unit = "Droideka",    	  health = 100,  speed = 4,   money_reward = 75},
		miniboss = { unit = "BX",             health = 210,  speed = 1.7, money_reward = 150},
		boss     = { unit = "Tact",           health = 9500, speed = 2,   money_reward = 1500},
	},
	Rewards = {
		
		Gems = 205,
		Items = { ["Youngling Sauce"] = 2, }, PlayerExp = 57
	},
	Rounds = {
		{
