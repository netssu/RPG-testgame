...
--[[Map is Hoth]]
	...
	Rewards = {
		...
		Gems = 225,
		Items = { ["Purple Milk"] = 2, }, PlayerExp = 60
	},
	Rounds = {
		{
...
--[[2]]		wave = { { unit = "normal",   amount = 4  }, 
					 { unit = "quick",    amount = 1  } },	wave_reward = 300, wave_diff_scale = 0.65}, 
		{
--[[3]]		wave = { { unit = "normal",   amount = 4  },
					 { unit = "tank",     amount = 1  } }, wave_reward = 400, wave_diff_scale = 0.75},
		{
...
--[[5]]		wave = { { unit = "normal",   amount = 4  },
					 { unit = "quick",    amount = 4  }, 
					 { unit = "tank",     amount = 2  }, 
					 { unit = "strong",   amount = 1  } }, wave_reward = 650, wave_diff_scale = 1}, 
		{
...
--[[10]]	wave = { { unit = "normal",   amount = 6  }, 
					 ...
					 { unit = "strong",   amount = 3  } }, wave_reward = 750, wave_diff_scale = 2.5}, 
		{
...
--[[12]]	wave = { { unit = "normal",   amount = 8  }, 
					 { unit = "quick",    amount = 6  }, 
					 { unit = "tank",     amount = 4  }, 
					 { unit = "quick",    amount = 4  } }, wave_reward = 800, wave_diff_scale = 3.5}, 
		{
