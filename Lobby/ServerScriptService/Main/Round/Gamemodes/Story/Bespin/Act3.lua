...
--[[Map is Hoth]]
	...
	Rewards = {
		...
		Gems = 235,
		Items = { ["Purple Milk"] = 3, }, PlayerExp = 66
	},
	Rounds = {
		{
...
--[[3]]		wave = { { unit = "normal",   amount = 6  },
					 { unit = "tank",     amount = 2  } }, wave_reward = 325, wave_diff_scale = 0.75},
		{
--[[4]]		wave = { { unit = "normal",   amount = 6  }, 
					 { unit = "quick",    amount = 3  }, 
					 { unit = "tank",     amount = 2  } }, wave_reward = 400, wave_diff_scale = 0.85},
		{
--[[5]]		wave = { { unit = "normal",   amount = 6  },
					 { unit = "quick",    amount = 5  }, 
					 { unit = "tank",     amount = 3  }, 
					 { unit = "miniboss", amount = 2  }, 
					 { unit = "strong",   amount = 3  } }, wave_reward = 600, wave_diff_scale = 0.95}, 
		{
...
--[[7]]		wave = { { unit = "normal",   amount = 7  }, 
					 { unit = "quick",    amount = 7  }, 
					 { unit = "tank",     amount = 4  } }, wave_reward = 650, wave_diff_scale = 1.25}, 
		{
