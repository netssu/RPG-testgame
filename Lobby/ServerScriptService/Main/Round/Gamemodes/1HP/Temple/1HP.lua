...
--[[Map is "Temple"]]
	...
	wave_rest_time = 3,
	EnemyStats = {
		normal   = { unit = "Ace",	    health = 1350,  speed = 4,    money_reward = 30},
		quick    = { unit = "Bobby", 	health = 1450,  speed = 6,    money_reward = 75},
		tank     = { unit = "Croozie",  health = 1500,  speed = 2.5,  money_reward = 50}, 
		strong   = { unit = "Jack the worst community manager in the world", health = 1550, speed = 1.5, money_reward = 75}, 
		debuff   = { unit = "Fauzen",   health = 1450,  speed = 2,    money_reward = 125, amount = 0.4}, --"Amount" = Debuff Multiplied on the Player's Damage in Range.
		miniboss = { unit = "Mathirix", health = 2250, speed = 3, money_reward = 150},
		boss     = { unit = "Scruffy",  health = 100000, speed = 2, money_reward = 1500},
